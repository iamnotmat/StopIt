...
final String resourcePath = resource.substring(1);
final String lib = join(dirname(Platform.script.path), "..", "..", "..", "lib");
final String libPath = lib.substring(1);
final String testDataPath = join(resourcePath, ".test", "test_data.json");

final String assets = join(dirname(Platform.script.path), "..", "assets");
final String assetsPath = assets.substring(1);
